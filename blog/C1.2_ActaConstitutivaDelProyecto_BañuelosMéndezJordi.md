...
<th>Hitos</th>
    ...
    * Problemas de rendimiento y compatibilidad con las tecnologías a utilizar
    ...
    <tr>
    <td>Por el momento no se tiene un presupuesto definido o calculado, por lo que se prefiere omitir que el valor a mencionar se trata de uno aproximado con el costo final, pero se tiene esperado que sea asumido por el patrocinador del proyecto. Se sugiere una cantidad de $30,000 MXN aproximadamente.</td>
</table>
<table>
    <th>Interesado</th>
    <th>Cargo</th>
