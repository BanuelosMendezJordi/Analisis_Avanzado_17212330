...
* Desde el archivo **.md** se debe exportar un archivo **.pdf** con la nomenclatura **C1.1_Trabajo_NombredelAlumno.pdf**, el cual deberá subirse a classroom dentro de su apartado correspondiente, para que sirva como evidencia de su entrega; siendo esta plataforma **oficial** aquí se recibirá la calificación de su actividad por individual.
